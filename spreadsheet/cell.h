...
public:
    ...
    ///Можно было бы использовать еще double в variant, но тогда для вывод "числовых" ячеек через GetText()
    ...
    /// числового значения (вычисляется сразу в Cell::Set и не инвалидируется)
